...
```bash
paseo plugin install npm:@alhassanaraouf/paseo-tokyo-night-storm
```

## Activate

1. Open **Settings \u2192 Appearance**.
2. Set **Theme** to **Tokyo Night Storm** for the dark variant or **Tokyo Night Storm Light** for the light variant.
