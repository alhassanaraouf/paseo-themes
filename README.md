...
| 18 | Cybertron | `@alhassanaraouf/paseo-cybertron-theme` | #2f3136 (dark only) | `#fe8019` | |
...
| 28 | LYT Mode | `@alhassanaraouf/paseo-lyt-mode-theme` | #2d3039 (dark only) | `#585f74` | |
...
| 47 | Discordian | `@alhassanaraouf/paseo-discordian-theme` | #2e3035 (dark only) | `#b088e7` | |
...
| 54 | Nier | `@alhassanaraouf/paseo-nier-theme` | #ddd8c7 (dark only) | `#6e695b` | |
| 55 | evangelion | `@alhassanaraouf/paseo-evangelion-theme` | #201430 (dark only) | `#8edf5f` | |
...
| 60 | Everblush | `@alhassanaraouf/paseo-everblush-theme` | #0f1619 (dark only) | `#bab3e5` | |
...
| 64 | Charcoal | `@alhassanaraouf/paseo-charcoal-theme` | #222527 (dark only) | `#9bb7c5` | |
| 65 | Comfort color dark | `@alhassanaraouf/paseo-comfort-color-dark-theme` | #2f3136 (dark only) | `#92a1a1` | |
...
| 68 | Emerald | `@alhassanaraouf/paseo-emerald-theme` | #1a1a1e (dark only) | `#237052` | |
| 69 | Firefly | `@alhassanaraouf/paseo-firefly-theme` | #1a1a1e (dark only) | `#2d8b62` | |
...
| 72 | Material Ocean | `@alhassanaraouf/paseo-material-ocean-theme` | #0f111a (dark only) | `#ff475a` | |
...
| 77 | halcyon | `@alhassanaraouf/paseo-halcyon-theme` | #1d2433 (dark only) | `#ffcc66` | |
...
| 81 | Dark Graphite | `@alhassanaraouf/paseo-dark-graphite-theme` | #161719 (dark only) | `#3c95fa` | |
| 82 | Dark Graphite Pie | `@alhassanaraouf/paseo-dark-graphite-pie-theme` | #212121 / #ffffff | `#20abe9` |  |
| 83 | Gastown | `@alhassanaraouf/paseo-gastown-theme` | #ffffff (light only) | `#020f2b` | |
| 84 | GDCT | `@alhassanaraouf/paseo-gdct-theme` | #fefefe (light only) | `#c15e50` | |
| 85 | GDCT Dark | `@alhassanaraouf/paseo-gdct-dark-theme` | #313030 (dark only) | `#000000` | |
| 86 | Gitsidian | `@alhassanaraouf/paseo-gitsidian-theme` | #1a1a1e / #ffffff | `#0366d6` |  |
| 87 | Hulk | `@alhassanaraouf/paseo-hulk-theme` | #1a1b24 (dark only) | `#00ba00` | |
